function EXPT = complang01_setup
    ...
    EXPT.subject(1).functional(1).para{3} = fullfile(paradir1,'subj01_09_ICGT.para');
    ...
    EXPT.subject(1).functional(2).para{3} = fullfile(paradir1,'subj01_11_ICGT.para');
    ...
    EXPT.subject(1).functional(3).para{3} = fullfile(paradir1,'subj01_13_ICGT.para');
    ...
    EXPT.subject(1).functional(4).para{3} = fullfile(paradir1,'subj01_15_DyLoc1.para');
    ...
    EXPT.subject(1).functional(5).para{3} = fullfile(paradir1,'subj01_17_DyLoc2.para');
    ...
    EXPT.subject(1).functional(6).para{3} = fullfile(paradir1,'subj01_19_ICGT.para');
    ...
    EXPT.subject(1).functional(7).para{3} = fullfile(paradir1,'subj01_21_ICGT.para');
    ...
    EXPT.subject(1).functional(8).para{3} = fullfile(paradir1,'subj01_23_ICGT.para');
    ...
    EXPT.subject(1).functional(9).para{3} = fullfile(paradir1,'subj01_25_DyLoc3.para');
    ...
    EXPT.subject(1).functional(10).para{3} = fullfile(paradir1,'subj01_27_DyLoc4.para');
    ...
    EXPT.subject(1).functional(11).para{3} = [];
    ...
    EXPT.subject(1).functional(12).para{3} = [];
    ...
    EXPT.subject(1).functional(13).para{3} = fullfile(paradir2,'subj01b_08_ICGT.para');
    ...
    EXPT.subject(1).functional(14).para{3} = fullfile(paradir2,'subj01b_10_ICGT.para');
    ...
    EXPT.subject(1).functional(15).para{3} = fullfile(paradir2,'subj01b_14_ICGT.para');
    ...
    EXPT.subject(1).functional(16).para{3} = fullfile(paradir2,'subj01b_16_ICGT.para');
    ...
    EXPT.subject(1).functional(17).para{3} = fullfile(paradir2,'subj01b_25_ICGT.para');
    ...
    EXPT.subject(1).functional(18).para{3} = fullfile(paradir2,'subj01b_27_ICGT.para');
    ...
    EXPT.subject(1).functional(19).para{3} = fullfile(paradir2,'subj01b_31_ICGT.para');
    ...
    EXPT.subject(1).functional(20).para{3} = fullfile(paradir2,'subj01b_33_ICGT.para');
    ...
    EXPT.subject(2).functional(1).para{3} = fullfile(paradir1,'subj02_05_superloc2conds_Parvizi_c1.para');
    ...
    EXPT.subject(2).functional(2).para{3} = fullfile(paradir1,'subj02_09_superloc2conds_Parvizi_c2.para');
    ...
    EXPT.subject(2).functional(3).para{3} = fullfile(paradir1,'subj02_11_ICGT.para');
    ...
    EXPT.subject(2).functional(4).para{3} = fullfile(paradir1,'subj02_13_ICGT.para');
    ...
    EXPT.subject(2).functional(5).para{3} = fullfile(paradir1,'subj02_15_DyLoc1.para');
    ...
    EXPT.subject(2).functional(6).para{3} = fullfile(paradir1,'subj02_17_DyLoc2.para');
    ...
    EXPT.subject(2).functional(7).para{3} = fullfile(paradir1,'subj02_19_ICGT.para');
    ...
    EXPT.subject(2).functional(8).para{3} = fullfile(paradir1,'subj02_21_ICGT.para');
    ...
    EXPT.subject(2).functional(9).para{3} = fullfile(paradir1,'subj02_23_ICGT.para');
    ...
    EXPT.subject(2).functional(10).para{3} = fullfile(paradir1,'subj02_25_ICGT.para');
    ...
    EXPT.subject(2).functional(11).para{3} = fullfile(paradir1,'subj02_27_DyLoc3.para');
    ...
    EXPT.subject(2).functional(12).para{3} = fullfile(paradir2,'subj02b_04_ICGT.para');
    ...
    EXPT.subject(2).functional(13).para{3} = fullfile(paradir2,'subj02b_06_ICGT.para');
    ...
    EXPT.subject(2).functional(14).para{3} = fullfile(paradir2,'subj02b_08_ICGT.para');
    ...
    EXPT.subject(2).functional(15).para{3} = fullfile(paradir2,'subj02b_10_ICGT.para');
    ...
    EXPT.subject(2).functional(16).para{3} = fullfile(paradir2,'subj02b_14_ICGT.para');
    ...
    EXPT.subject(2).functional(17).para{3} = fullfile(paradir2,'subj02b_16_ICGT.para');
    ...
    EXPT.subject(2).functional(18).para{3} = fullfile(paradir2,'subj02b_18_ICGT.para');
    ...
    EXPT.subject(2).functional(19).para{3} = fullfile(paradir2,'subj02b_20_ICGT.para');
    ...
    EXPT.subject(3).functional(1).para{3} = fullfile(paradir1,'subj03_06_ICGT.para');
    ...
    EXPT.subject(3).functional(2).para{3} = fullfile(paradir1,'subj03_08_ICGT.para');
    ...
    EXPT.subject(3).functional(3).para{3} = fullfile(paradir1,'subj03_10_ICGT.para');
    ...
    EXPT.subject(3).functional(4).para{3} = fullfile(paradir1,'subj03_12_DyLoc1.para');
    ...
    EXPT.subject(3).functional(5).para{3} = fullfile(paradir1,'subj03_14_DyLoc2.para');
    ...
    EXPT.subject(3).functional(6).para{3} = fullfile(paradir1,'subj03_16_ICGT.para');
    ...
    EXPT.subject(3).functional(7).para{3} = fullfile(paradir1,'subj03_18_ICGT.para');
    ...
    EXPT.subject(3).functional(8).para{3} = fullfile(paradir1,'subj03_20_ICGT.para');
    ...
    EXPT.subject(3).functional(9).para{3} = fullfile(paradir1,'subj03_22_DyLoc3.para');
    ...
    EXPT.subject(3).functional(10).para{3} = fullfile(paradir1,'subj03_24_DyLoc4.para');
    ...
    EXPT.subject(3).functional(11).para{3} = fullfile(paradir2,'subj03b_04_ICGT.para');
    ...
    EXPT.subject(3).functional(12).para{3} = fullfile(paradir2,'subj03b_06_ICGT.para');
    ...
    EXPT.subject(3).functional(13).para{3} = fullfile(paradir2,'subj03b_08_ICGT.para');
    ...
    EXPT.subject(3).functional(14).para{3} = fullfile(paradir2,'subj03b_10_ICGT.para');
    ...
    EXPT.subject(3).functional(15).para{3} = fullfile(paradir2,'subj03b_12_superloc2conds_Parvizi_c1.para');
    ...
    EXPT.subject(3).functional(16).para{3} = fullfile(paradir2,'subj03b_14_superloc2conds_Parvizi_c2.para');
    ...
    EXPT.subject(3).functional(17).para{3} = fullfile(paradir2,'subj03b_16_ICGT.para');
    ...
    EXPT.subject(3).functional(18).para{3} = fullfile(paradir2,'subj03b_18_ICGT.para');
    ...
    EXPT.subject(3).functional(19).para{3} = fullfile(paradir2,'subj03b_20_ICGT.para');
    ...
    EXPT.subject(3).functional(20).para{3} = fullfile(paradir2,'subj03b_22_ICGT.para');
    ...
    EXPT.subject(4).functional(1).para{3} = fullfile(paradir1,'subj04_08_ICGT.para');
    ...
    EXPT.subject(4).functional(2).para{3} = fullfile(paradir1,'subj04_10_ICGT.para');
    ...
    EXPT.subject(4).functional(3).para{3} = fullfile(paradir1,'subj04_12_ICGT.para');
    ...
    EXPT.subject(4).functional(4).para{3} = fullfile(paradir1,'subj04_16_DyLoc1.para');
    ...
    EXPT.subject(4).functional(5).para{3} = fullfile(paradir1,'subj04_18_ICGT.para');
    ...
    EXPT.subject(4).functional(6).para{3} = fullfile(paradir1,'subj04_20_ICGT.para');
    ...
    EXPT.subject(4).functional(7).para{3} = fullfile(paradir1,'subj04_22_ICGT.para');
    ...
    EXPT.subject(4).functional(8).para{3} = fullfile(paradir2,'subj04b_06_ICGT.para');
    ...
    EXPT.subject(4).functional(9).para{3} = fullfile(paradir2,'subj04b_08_ICGT.para');
    ...
    EXPT.subject(4).functional(10).para{3} = fullfile(paradir2,'subj04b_10_ICGT.para');
    ...
    EXPT.subject(4).functional(11).para{3} = fullfile(paradir2,'subj04b_12_ICGT.para');
    ...
    EXPT.subject(4).functional(12).para{3} = fullfile(paradir2,'subj04b_14_superloc2conds_Parvizi_c1.para');
    ...
    EXPT.subject(4).functional(13).para{3} = fullfile(paradir2,'subj04b_16_superloc2conds_Parvizi_c2.para');
    ...
    EXPT.subject(4).functional(14).para{3} = fullfile(paradir2,'subj04b_18_ICGT.para');
    ...
    EXPT.subject(4).functional(15).para{3} = fullfile(paradir2,'subj04b_20_ICGT.para');
    ...
    EXPT.subject(4).functional(16).para{3} = fullfile(paradir2,'subj04b_22_ICGT.para');
    ...
    EXPT.subject(4).functional(17).para{3} = fullfile(paradir2,'subj04b_24_ICGT.para');