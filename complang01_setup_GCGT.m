function EXPT = complang01_setup
    ...
    EXPT.subject(1).functional(1).para{1} = fullfile(paradir1,'subj01_09_GCGT.para');
    ...
    EXPT.subject(1).functional(2).para{1} = fullfile(paradir1,'subj01_11_GCGT.para');
    ...
    EXPT.subject(1).functional(3).para{1} = fullfile(paradir1,'subj01_13_GCGT.para');
    ...
    EXPT.subject(1).functional(6).para{1} = fullfile(paradir1,'subj01_19_GCGT.para');
    ...
    EXPT.subject(1).functional(7).para{1} = fullfile(paradir1,'subj01_21_GCGT.para');
    ...
    EXPT.subject(1).functional(8).para{1} = fullfile(paradir1,'subj01_23_GCGT.para');
    ...
    EXPT.subject(1).functional(13).para{1} = fullfile(paradir2,'subj01b_08_GCGT.para');
    ...
    EXPT.subject(1).functional(14).para{1} = fullfile(paradir2,'subj01b_10_GCGT.para');
    ...
    EXPT.subject(1).functional(15).para{1} = fullfile(paradir2,'subj01b_14_GCGT.para');
    ...
    EXPT.subject(1).functional(16).para{1} = fullfile(paradir2,'subj01b_16_GCGT.para');
    ...
    EXPT.subject(1).functional(17).para{1} = fullfile(paradir2,'subj01b_25_GCGT.para');
    ...
    EXPT.subject(1).functional(18).para{1} = fullfile(paradir2,'subj01b_27_GCGT.para');
    ...
    EXPT.subject(1).functional(19).para{1} = fullfile(paradir2,'subj01b_31_GCGT.para');
    ...
    EXPT.subject(1).functional(20).para{1} = fullfile(paradir2,'subj01b_33_GCGT.para');
    ...
    EXPT.subject(2).functional(3).para{1} = fullfile(paradir1,'subj02_11_GCGT.para');
    ...
    EXPT.subject(2).functional(4).para{1} = fullfile(paradir1,'subj02_13_GCGT.para');
    ...
    EXPT.subject(2).functional(7).para{1} = fullfile(paradir1,'subj02_19_GCGT.para');
    ...
    EXPT.subject(2).functional(8).para{1} = fullfile(paradir1,'subj02_21_GCGT.para');
    ...
    EXPT.subject(2).functional(9).para{1} = fullfile(paradir1,'subj02_23_GCGT.para');
    ...
    EXPT.subject(2).functional(10).para{1} = fullfile(paradir1,'subj02_25_GCGT.para');
    ...
    EXPT.subject(2).functional(12).para{1} = fullfile(paradir2,'subj02b_04_GCGT.para');
    ...
    EXPT.subject(2).functional(13).para{1} = fullfile(paradir2,'subj02b_06_GCGT.para');
    ...
    EXPT.subject(2).functional(14).para{1} = fullfile(paradir2,'subj02b_08_GCGT.para');
    ...
    EXPT.subject(2).functional(15).para{1} = fullfile(paradir2,'subj02b_10_GCGT.para');
    ...
    EXPT.subject(2).functional(16).para{1} = fullfile(paradir2,'subj02b_14_GCGT.para');
    ...
    EXPT.subject(2).functional(17).para{1} = fullfile(paradir2,'subj02b_16_GCGT.para');
    ...
    EXPT.subject(2).functional(18).para{1} = fullfile(paradir2,'subj02b_18_GCGT.para');
    ...
    EXPT.subject(2).functional(19).para{1} = fullfile(paradir2,'subj02b_20_GCGT.para');
    ...
    EXPT.subject(3).functional(1).para{1} = fullfile(paradir1,'subj03_06_GCGT.para');
    ...
    EXPT.subject(3).functional(2).para{1} = fullfile(paradir1,'subj03_08_GCGT.para');
    ...
    EXPT.subject(3).functional(3).para{1} = fullfile(paradir1,'subj03_10_GCGT.para');
    ...
    EXPT.subject(3).functional(4).para{1} = fullfile(paradir1,'subj03_12_DyLoc1.para');
    ...
    EXPT.subject(3).functional(5).para{1} = fullfile(paradir1,'subj03_14_DyLoc2.para');
    ...
    EXPT.subject(3).functional(6).para{1} = fullfile(paradir1,'subj03_16_GCGT.para');
    ...
    EXPT.subject(3).functional(7).para{1} = fullfile(paradir1,'subj03_18_GCGT.para');
    ...
    EXPT.subject(3).functional(8).para{1} = fullfile(paradir1,'subj03_20_GCGT.para');
    ...
    EXPT.subject(3).functional(9).para{1} = fullfile(paradir1,'subj03_22_DyLoc3.para');
    ...
    EXPT.subject(3).functional(10).para{1} = fullfile(paradir1,'subj03_24_DyLoc4.para');
    ...
    EXPT.subject(3).functional(11).para{1} = fullfile(paradir2,'subj03b_04_GCGT.para');
    ...
    EXPT.subject(3).functional(12).para{1} = fullfile(paradir2,'subj03b_06_GCGT.para');
    ...
    EXPT.subject(3).functional(13).para{1} = fullfile(paradir2,'subj03b_08_GCGT.para');
    ...
    EXPT.subject(3).functional(14).para{1} = fullfile(paradir2,'subj03b_10_GCGT.para');
    ...
    EXPT.subject(3).functional(15).para{1} = fullfile(paradir2,'subj03b_12_superloc2conds_Parvizi_c1.para');
    ...
    EXPT.subject(3).functional(17).para{1} = fullfile(paradir2,'subj03b_16_GCGT.para');
    ...
    EXPT.subject(3).functional(18).para{1} = fullfile(paradir2,'subj03b_18_GCGT.para');
    ...
    EXPT.subject(3).functional(19).para{1} = fullfile(paradir2,'subj03b_20_GCGT.para');
    ...
    EXPT.subject(3).functional(20).para{1} = fullfile(paradir2,'subj03b_22_GCGT.para');
    ...
    EXPT.subject(4).functional(1).para{1} = fullfile(paradir1,'subj04_08_GCGT.para');
    ...
    EXPT.subject(4).functional(2).para{1} = fullfile(paradir1,'subj04_10_GCGT.para');
    ...
    EXPT.subject(4).functional(3).para{1} = fullfile(paradir1,'subj04_12_GCGT.para');
    ...
    EXPT.subject(4).functional(4).para{1} = fullfile(paradir1,'subj04_16_DyLoc1.para');
    ...
    EXPT.subject(4).functional(5).para{1} = fullfile(paradir1,'subj04_18_GCGT.para');
    ...
    EXPT.subject(4).functional(6).para{1} = fullfile(paradir1,'subj04_20_GCGT.para');
    ...
    EXPT.subject(4).functional(7).para{1} = fullfile(paradir1,'subj04_22_GCGT.para');
    ...
    EXPT.subject(4).functional(8).para{1} = fullfile(paradir2,'subj04b_06_GCGT.para');
    ...
    EXPT.subject(4).functional(9).para{1} = fullfile(paradir2,'subj04b_08_GCGT.para');
    ...
    EXPT.subject(4).functional(10).para{1} = fullfile(paradir2,'subj04b_10_GCGT.para');
    ...
    EXPT.subject(4).functional(11).para{1} = fullfile(paradir2,'subj04b_12_GCGT.para');
    ...
    EXPT.subject(4).functional(12).para{1} = fullfile(paradir2,'subj04b_14_superloc2conds_Parvizi_c1.para');
    ...
    EXPT.subject(4).functional(13).para{1} = fullfile(paradir2,'subj04b_16_superloc2conds_Parvizi_c2.para');
    ...
    EXPT.subject(4).functional(14).para{1} = fullfile(paradir2,'subj04b_18_GCGT.para');
    ...
    EXPT.subject(4).functional(15).para{1} = fullfile(paradir2,'subj04b_20_GCGT.para');
    ...
    EXPT.subject(4).functional(16).para{1} = fullfile(paradir2,'subj04b_22_GCGT.para');
    ...
    EXPT.subject(4).functional(17).para{1} = fullfile(paradir2,'subj04b_24_GCGT.para');