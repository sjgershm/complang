function EXPT = complang02_setup
    ...
    EXPT.subject(4).functional(23).para{1} = fullfile(paradir2,'subj04b_25_ICGT.para');
    ...
    EXPT.subject(4).functional(24).para{1} = fullfile(paradir2,'subj04b_27_ICGT.para');
    ...
    EXPT.subject(4).functional(25).para{1} = fullfile(paradir3,'subj04c_03_ICGT.para');
    ...
    EXPT.subject(4).functional(26).para{1} = fullfile(paradir3,'subj04c_05_ICGT.para');
    ...
    EXPT.subject(4).functional(27).para{1} = fullfile(paradir3,'subj04c_07_ICGT.para');
    ...
    EXPT.subject(4).functional(28).para{1} = fullfile(paradir3,'subj04c_09_ICGT.para');
    ...
    EXPT.subject(4).functional(29).para{1} = fullfile(paradir3,'subj04c_11_ICGT.para');
    ...
    EXPT.subject(4).functional(30).para{1} = fullfile(paradir4,'subj04d_05_ICGT.para');
    ...
    EXPT.subject(4).functional(31).para{1} = fullfile(paradir4,'subj04d_07_ICGT.para');
    ...
    EXPT.subject(4).functional(32).para{1} = fullfile(paradir4,'subj04d_09_ICGT.para');
    ...
    EXPT.subject(4).functional(33).para{1} = fullfile(paradir4,'subj04d_11_ICGT.para');
    ...
    EXPT.subject(4).functional(34).para{1} = fullfile(paradir4,'subj04d_13_ICGT.para');
    ...
    EXPT.subject(4).functional(35).para{1} = fullfile(paradir4,'subj04d_15_ICGT.para');
    ...
    EXPT.subject(4).functional(36).para{1} = fullfile(paradir4,'subj04d_17_ICGT.para');
    ...
    EXPT.subject(4).functional(37).para{1} = fullfile(paradir4,'subj04d_19_ICGT.para');
    ...
    EXPT.subject(4).functional(38).para{1} = fullfile(paradir4,'subj04d_21_ICGT.para');
    ...
    EXPT.subject(4).functional(39).para{1} = fullfile(paradir4,'subj04d_23_ICGT.para');
    ...
    EXPT.subject(4).functional(40).para{1} = fullfile(paradir5,'subj04e_05_ICGT.para');
    ...
    EXPT.subject(4).functional(41).para{1} = fullfile(paradir5,'subj04e_07_ICGT.para');
    ...
    EXPT.subject(4).functional(42).para{1} = fullfile(paradir5,'subj04e_09_ICGT.para');
    ...
    EXPT.subject(4).functional(43).para{1} = fullfile(paradir5,'subj04e_11_ICGT.para');
    ...
    EXPT.subject(4).functional(44).para{1} = fullfile(paradir5,'subj04e_13_ICGT.para');
    ...
    EXPT.subject(4).functional(45).para{1} = fullfile(paradir5,'subj04e_15_ICGT.para');
    ...
    EXPT.subject(4).functional(46).para{1} = fullfile(paradir5,'subj04e_17_ICGT.para');
    ...
    EXPT.subject(4).functional(47).para{1} = fullfile(paradir5,'subj04e_19_ICGT.para');
    ...
    EXPT.subject(4).functional(48).para{1} = fullfile(paradir5,'subj04e_21_ICGT.para');
    ...
    EXPT.subject(4).functional(49).para{1} = fullfile(paradir5,'subj04e_23_ICGT.para');
    ...
    EXPT.subject(4).functional(50).para{1} = fullfile(paradir6,'subj04f_03_ICGT.para');
    ...
    EXPT.subject(4).functional(51).para{1} = fullfile(paradir6,'subj04f_05_ICGT.para');
    ...
    EXPT.subject(4).functional(52).para{1} = fullfile(paradir6,'subj04f_07_ICGT.para');
    ...
    EXPT.subject(4).functional(53).para{1} = fullfile(paradir6,'subj04f_09_ICGT.para');
    ...
    EXPT.subject(4).functional(54).para{1} = fullfile(paradir6,'subj04f_11_ICGT.para');
    ...
    EXPT.subject(4).functional(55).para{1} = fullfile(paradir6,'subj04f_13_ICGT.para');
    ...
    EXPT.subject(4).functional(56).para{1} = fullfile(paradir6,'subj04f_15_ICGT.para');
    ...
    EXPT.subject(4).functional(57).para{1} = fullfile(paradir6,'subj04f_17_ICGT.para');
    ...
    EXPT.subject(4).functional(58).para{1} = fullfile(paradir6,'subj04f_19_ICGT.para');
    ...
    EXPT.subject(4).functional(59).para{1} = fullfile(paradir6,'subj04f_21_ICGT.para');
    ...
    EXPT.subject(4).functional(60).para{1} = fullfile(paradir6,'subj04f_23_ICGT.para');
    ...
    EXPT.subject(4).functional(61).para{1} = fullfile(paradir6,'subj04f_25_ICGT.para');
    ...
    EXPT.subject(5).functional(26).para{1} = fullfile(paradir3,'subj05c_05_ICGT.para');
    ...
    EXPT.subject(5).functional(27).para{1} = fullfile(paradir3,'subj05c_07_ICGT.para');
    ...
    EXPT.subject(5).functional(28).para{1} = fullfile(paradir3,'subj05c_09_ICGT.para');
    ...
    EXPT.subject(5).functional(29).para{1} = fullfile(paradir3,'subj05c_11_ICGT.para');
    ...
    EXPT.subject(5).functional(30).para{1} = fullfile(paradir3,'subj05c_13_ICGT.para');
    ...
    EXPT.subject(5).functional(31).para{1} = fullfile(paradir3,'subj05c_15_ICGT.para');
    ...
    EXPT.subject(5).functional(32).para{1} = fullfile(paradir3,'subj05c_17_ICGT.para');
    ...
    EXPT.subject(5).functional(33).para{1} = fullfile(paradir3,'subj05c_19_ICGT.para');
    ...
    EXPT.subject(5).functional(34).para{1} = fullfile(paradir3,'subj05c_21_ICGT.para');
    ...
    EXPT.subject(5).functional(35).para{1} = fullfile(paradir3,'subj05c_23_ICGT.para');
    ...
    EXPT.subject(5).functional(36).para{1} = fullfile(paradir3,'subj05c_25_ICGT.para');
    ...
    EXPT.subject(5).functional(38).para{1} = fullfile(paradir4,'subj05d_03_ICGT.para');
    ...
    EXPT.subject(5).functional(39).para{1} = fullfile(paradir4,'subj05d_05_ICGT.para');
    ...
    EXPT.subject(5).functional(40).para{1} = fullfile(paradir4,'subj05d_07_ICGT.para');
    ...
    EXPT.subject(5).functional(41).para{1} = fullfile(paradir4,'subj05d_09_ICGT.para');
    ...
    EXPT.subject(5).functional(42).para{1} = fullfile(paradir4,'subj05d_11_ICGT.para');
    ...
    EXPT.subject(5).functional(43).para{1} = fullfile(paradir4,'subj05d_13_ICGT.para');
    ...
    EXPT.subject(5).functional(44).para{1} = fullfile(paradir4,'subj05d_15_ICGT.para');
    ...
    EXPT.subject(5).functional(45).para{1} = fullfile(paradir4,'subj05d_17_ICGT.para');
    ...
    EXPT.subject(5).functional(46).para{1} = fullfile(paradir4,'subj05d_19_ICGT.para');
    ...
    EXPT.subject(5).functional(47).para{1} = fullfile(paradir4,'subj05d_21_ICGT.para');
    ...
    EXPT.subject(5).functional(48).para{1} = fullfile(paradir4,'subj05d_23_ICGT.para');
    ...
    EXPT.subject(5).functional(49).para{1} = fullfile(paradir4,'subj05d_25_ICGT.para');
    ...
    EXPT.subject(5).functional(50).para{1} = fullfile(paradir5,'subj05e_03_ICGT.para');
    ...
    EXPT.subject(5).functional(51).para{1} = fullfile(paradir5,'subj05e_05_ICGT.para');
    ...
    EXPT.subject(5).functional(52).para{1} = fullfile(paradir5,'subj05e_07_ICGT.para');
    ...
    EXPT.subject(5).functional(53).para{1} = fullfile(paradir5,'subj05e_09_ICGT.para');
    ...
    EXPT.subject(5).functional(54).para{1} = fullfile(paradir5,'subj05e_11_ICGT.para');
    ...
    EXPT.subject(5).functional(55).para{1} = fullfile(paradir5,'subj05e_13_ICGT.para');
    ...
    EXPT.subject(5).functional(56).para{1} = fullfile(paradir5,'subj05e_15_ICGT.para');
    ...
    EXPT.subject(5).functional(57).para{1} = fullfile(paradir5,'subj05e_17_ICGT.para');
    ...
    EXPT.subject(5).functional(58).para{1} = fullfile(paradir5,'subj05e_19_ICGT.para');
    ...
    EXPT.subject(5).functional(59).para{1} = fullfile(paradir5,'subj05e_21_ICGT.para');
    ...
    EXPT.subject(5).functional(60).para{1} = fullfile(paradir5,'subj05e_23_ICGT.para');
    ...
    EXPT.subject(5).functional(61).para{1} = fullfile(paradir5,'subj05e_25_ICGT.para');
    %----------------------------------%
    %           SUBJECT 6              
    %----------------------------------%
    ...
    EXPT.subject(6).functional(13).para{1} = fullfile(paradir3,'subj06c_03_ICGT.para');
    ...
    EXPT.subject(6).functional(14).para{1} = fullfile(paradir3,'subj06c_05_ICGT.para');
    ...
    EXPT.subject(6).functional(15).para{1} = fullfile(paradir3,'subj06c_07_ICGT.para');
    ...
    EXPT.subject(6).functional(16).para{1} = fullfile(paradir3,'subj06c_09_ICGT.para');
    ...
    EXPT.subject(6).functional(17).para{1} = fullfile(paradir3,'subj06c_11_ICGT.para');
    ...
    EXPT.subject(6).functional(18).para{1} = fullfile(paradir3,'subj06c_13_ICGT.para');
    ...
    EXPT.subject(6).functional(19).para{1} = fullfile(paradir3,'subj06c_15_ICGT.para');
    ...
    EXPT.subject(6).functional(20).para{1} = fullfile(paradir3,'subj06c_17_ICGT.para');
    ...
    EXPT.subject(6).functional(21).para{1} = fullfile(paradir3,'subj06c_19_ICGT.para');
    ...
    EXPT.subject(6).functional(22).para{1} = fullfile(paradir3,'subj06c_21_ICGT.para');
    ...
    EXPT.subject(7).functional(25).para{1} = fullfile(paradir3,'subj07c_03_ICGT.para');
    ...
    EXPT.subject(7).functional(26).para{1} = fullfile(paradir3,'subj07c_05_ICGT.para');
    ...
    EXPT.subject(7).functional(27).para{1} = fullfile(paradir3,'subj07c_07_ICGT.para');
    ...
    EXPT.subject(7).functional(28).para{1} = fullfile(paradir3,'subj07c_09_ICGT.para');
    ...
    EXPT.subject(7).functional(29).para{1} = fullfile(paradir3,'subj07c_11_ICGT.para');
    ...
    EXPT.subject(7).functional(30).para{1} = fullfile(paradir3,'subj07c_13_ICGT.para');
    ...
    EXPT.subject(7).functional(31).para{1} = fullfile(paradir3,'subj07c_15_ICGT.para');
    ...
    EXPT.subject(7).functional(32).para{1} = fullfile(paradir3,'subj07c_17_ICGT.para');
    ...
    EXPT.subject(7).functional(33).para{1} = fullfile(paradir3,'subj07c_19_ICGT.para');
    ...
    EXPT.subject(7).functional(34).para{1} = fullfile(paradir3,'subj07c_21_ICGT.para');
    ...
    EXPT.subject(8).functional(12).para{1} = fullfile(paradir2,'subj08b_03_ICGT.para');
    ...
    EXPT.subject(8).functional(13).para{1} = fullfile(paradir2,'subj08b_05_ICGT.para');
    ...
    EXPT.subject(8).functional(14).para{1} = fullfile(paradir2,'subj08b_07_ICGT.para');
    ...
    EXPT.subject(8).functional(15).para{1} = fullfile(paradir2,'subj08b_09_ICGT.para');
    ...
    EXPT.subject(8).functional(16).para{1} = fullfile(paradir2,'subj08b_11_ICGT.para');
    ...
    EXPT.subject(8).functional(17).para{1} = fullfile(paradir2,'subj08b_13_ICGT.para');
    ...
    EXPT.subject(8).functional(18).para{1} = fullfile(paradir2,'subj08b_15_ICGT.para');
    ...
    EXPT.subject(8).functional(19).para{1} = fullfile(paradir2,'subj08b_17_ICGT.para');
    ...
    EXPT.subject(8).functional(20).para{1} = fullfile(paradir2,'subj08b_19_ICGT.para');
    ...
    EXPT.subject(8).functional(21).para{1} = fullfile(paradir3,'subj08c_05_ICGT.para');
    ...
    EXPT.subject(8).functional(22).para{1} = fullfile(paradir3,'subj08c_07_ICGT.para');
    ...
    EXPT.subject(8).functional(23).para{1} = fullfile(paradir3,'subj08c_09_ICGT.para');
    ...
    EXPT.subject(8).functional(24).para{1} = fullfile(paradir3,'subj08c_11_ICGT.para');
    ...
    EXPT.subject(8).functional(25).para{1} = fullfile(paradir3,'subj08c_13_ICGT.para');
    ...
    EXPT.subject(8).functional(26).para{1} = fullfile(paradir3,'subj08c_15_ICGT.para');
    ...
    EXPT.subject(8).functional(27).para{1} = fullfile(paradir3,'subj08c_17_ICGT.para');
    ...
    EXPT.subject(8).functional(28).para{1} = fullfile(paradir3,'subj08c_19_ICGT.para');
    ...
    EXPT.subject(8).functional(29).para{1} = fullfile(paradir3,'subj08c_21_ICGT.para');
    ...
    EXPT.subject(8).functional(30).para{1} = fullfile(paradir3,'subj08c_23_ICGT.para');
    ...
    EXPT.subject(8).functional(31).para{1} = fullfile(paradir3,'subj08c_25_ICGT.para');
