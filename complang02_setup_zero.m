function EXPT = complang02_setup
    ...
    EXPT.subject(1).functional(1).para{3} = fullfile(paradir1,'subj01_06_ICGT.para');
    ...
    EXPT.subject(1).functional(2).para{3} = fullfile(paradir1,'subj01_08_ICGT.para');
    ...
    EXPT.subject(1).functional(5).para{3} = fullfile(paradir1,'subj01_16_ICGT.para');
    ...
    EXPT.subject(1).functional(6).para{3} = fullfile(paradir1,'subj01_18_ICGT.para');
    ...
    EXPT.subject(1).functional(7).para{3} = fullfile(paradir2,'subj01b_05_ICGT.para');
    ...
    EXPT.subject(1).functional(8).para{3} = fullfile(paradir2,'subj01b_07_ICGT.para');
    ...
    EXPT.subject(1).functional(9).para{3} = fullfile(paradir2,'subj01b_09_ICGT.para');
    ...
    EXPT.subject(1).functional(10).para{3} = fullfile(paradir2,'subj01b_11_ICGT.para');
    ...
    EXPT.subject(1).functional(11).para{3} = fullfile(paradir2,'subj01b_13_ICGT.para');
    ...
    EXPT.subject(1).functional(12).para{3} = fullfile(paradir2,'subj01b_15_ICGT.para');
    ...
    EXPT.subject(1).functional(13).para{3} = fullfile(paradir2,'subj01b_17_ICGT.para');
    ...
    EXPT.subject(1).functional(14).para{3} = fullfile(paradir2,'subj01b_19_ICGT.para');
    ...
    EXPT.subject(1).functional(15).para{3} = fullfile(paradir3,'subj01c_04_ICGT.para');
    ...
    EXPT.subject(1).functional(16).para{3} = fullfile(paradir3,'subj01c_06_ICGT.para');
    ...
    EXPT.subject(1).functional(17).para{3} = fullfile(paradir3,'subj01c_08_ICGT.para');
    ...
    EXPT.subject(1).functional(18).para{3} = fullfile(paradir3,'subj01c_10_ICGT.para');
    ...
    EXPT.subject(1).functional(19).para{3} = fullfile(paradir3,'subj01c_12_ICGT.para');
    ...
    EXPT.subject(1).functional(20).para{3} = fullfile(paradir3,'subj01c_14_ICGT.para');
    ...
    EXPT.subject(1).functional(21).para{3} = fullfile(paradir3,'subj01c_16_ICGT.para');
    ...
    EXPT.subject(1).functional(22).para{3} = fullfile(paradir3,'subj01c_18_ICGT.para');
    ...
    EXPT.subject(1).functional(23).para{3} = fullfile(paradir3,'subj01c_20_ICGT.para');
    ...
    EXPT.subject(1).functional(24).para{3} = fullfile(paradir4,'subj01d_04_ICGT.para');
    ...
    EXPT.subject(1).functional(25).para{3} = fullfile(paradir4,'subj01d_06_ICGT.para');
    ...
    EXPT.subject(1).functional(26).para{3} = fullfile(paradir4,'subj01d_08_ICGT.para');
    ...
    EXPT.subject(1).functional(27).para{3} = fullfile(paradir4,'subj01d_10_ICGT.para');
    ...
    EXPT.subject(1).functional(28).para{3} = fullfile(paradir4,'subj01d_12_ICGT.para');
    ...
    EXPT.subject(1).functional(29).para{3} = fullfile(paradir4,'subj01d_14_ICGT.para');
    ...
    EXPT.subject(1).functional(30).para{3} = fullfile(paradir5,'subj01e_06_ICGT.para');
    ...
    EXPT.subject(1).functional(31).para{3} = fullfile(paradir5,'subj01e_08_ICGT.para');
    ...
    EXPT.subject(1).functional(32).para{3} = fullfile(paradir5,'subj01e_10_ICGT.para');
    ...
    EXPT.subject(1).functional(33).para{3} = fullfile(paradir5,'subj01e_12_ICGT.para');
    ...
    EXPT.subject(2).functional(1).para{3} = fullfile(paradir1,'subj02_06_ICGT.para');
    ...
    EXPT.subject(2).functional(2).para{3} = fullfile(paradir1,'subj02_08_ICGT.para');
    ...
    EXPT.subject(2).functional(3).para{3} = fullfile(paradir1,'subj02_10_ICGT.para');
    ...
    EXPT.subject(2).functional(6).para{3} = fullfile(paradir1,'subj02_16_ICGT.para');
    ...
    EXPT.subject(2).functional(7).para{3} = fullfile(paradir1,'subj02_18_ICGT.para');
    ...
    EXPT.subject(2).functional(8).para{3} = fullfile(paradir1,'subj02_20_ICGT.para');
    ...
    EXPT.subject(2).functional(9).para{3} = fullfile(paradir1,'subj02_22_ICGT.para');
    ...
    EXPT.subject(2).functional(10).para{3} = fullfile(paradir1,'subj02_24_ICGT.para');
    ...
    EXPT.subject(2).functional(11).para{3} = fullfile(paradir2,'subj02b_06_ICGT.para');
    ...
    EXPT.subject(2).functional(12).para{3} = fullfile(paradir2,'subj02b_08_ICGT.para');
    ...
    EXPT.subject(2).functional(13).para{3} = fullfile(paradir2,'subj02b_10_ICGT.para');
    ...
    EXPT.subject(2).functional(14).para{3} = fullfile(paradir2,'subj02b_12_ICGT.para');
    ...
    EXPT.subject(2).functional(15).para{3} = fullfile(paradir2,'subj02b_14_ICGT.para');
    ...
    EXPT.subject(2).functional(16).para{3} = fullfile(paradir2,'subj02b_16_ICGT.para');
    ...
    EXPT.subject(2).functional(17).para{3} = fullfile(paradir2,'subj02b_18_ICGT.para');
    ...
    EXPT.subject(2).functional(18).para{3} = fullfile(paradir2,'subj02b_20_ICGT.para');
    ...
    EXPT.subject(2).functional(19).para{3} = fullfile(paradir3,'subj02c_04_ICGT.para');
    ...
    EXPT.subject(2).functional(20).para{3} = fullfile(paradir3,'subj02c_06_ICGT.para');
    ...
    EXPT.subject(2).functional(21).para{3} = fullfile(paradir3,'subj02c_08_ICGT.para');
    ...
    EXPT.subject(2).functional(22).para{3} = fullfile(paradir3,'subj02c_10_ICGT.para');
    ...
    EXPT.subject(2).functional(23).para{3} = fullfile(paradir3,'subj02c_12_ICGT.para');
    ...
    EXPT.subject(2).functional(24).para{3} = fullfile(paradir3,'subj02c_14_ICGT.para');
    ...
    EXPT.subject(2).functional(25).para{3} = fullfile(paradir3,'subj02c_16_ICGT.para');
    ...
    EXPT.subject(2).functional(26).para{3} = fullfile(paradir3,'subj02c_18_ICGT.para');
    ...
    EXPT.subject(2).functional(27).para{3} = fullfile(paradir3,'subj02c_20_ICGT.para');
    ...
    EXPT.subject(2).functional(28).para{3} = fullfile(paradir3,'subj02c_22_ICGT.para');
    ...
    EXPT.subject(2).functional(29).para{3} = fullfile(paradir4,'subj02d_03_ICGT.para');
    ...
    EXPT.subject(2).functional(30).para{3} = fullfile(paradir4,'subj02d_05_ICGT.para');
    ...
    EXPT.subject(2).functional(31).para{3} = fullfile(paradir4,'subj02d_07_ICGT.para');
    ...
    EXPT.subject(2).functional(32).para{3} = fullfile(paradir4,'subj02d_09_ICGT.para');
    ...
    EXPT.subject(2).functional(33).para{3} = fullfile(paradir4,'subj02d_11_ICGT.para');
    ...
    EXPT.subject(2).functional(34).para{3} = fullfile(paradir4,'subj02d_13_ICGT.para');
    ...
    EXPT.subject(3).functional(1).para{3} = fullfile(paradir1,'subj03_08_ICGT.para');
    ...
    EXPT.subject(3).functional(2).para{3} = fullfile(paradir1,'subj03_10_ICGT.para');
    ...
    EXPT.subject(3).functional(3).para{3} = fullfile(paradir1,'subj03_12_ICGT.para');
    ...
    EXPT.subject(3).functional(6).para{3} = fullfile(paradir1,'subj03_20_ICGT.para');
    ...
    EXPT.subject(3).functional(7).para{3} = fullfile(paradir1,'subj03_22_ICGT.para');
    ...
    EXPT.subject(3).functional(8).para{3} = fullfile(paradir2,'subj03b_03_ICGT.para');
    ...
    EXPT.subject(3).functional(9).para{3} = fullfile(paradir2,'subj03b_05_ICGT.para');
    ...
    EXPT.subject(3).functional(10).para{3} = fullfile(paradir2,'subj03b_07_ICGT.para');
    ...
    EXPT.subject(3).functional(11).para{3} = fullfile(paradir2,'subj03b_09_ICGT.para');
    ...
    EXPT.subject(3).functional(12).para{3} = fullfile(paradir2,'subj03b_11_ICGT.para');
    ...
    EXPT.subject(4).functional(1).para{3} = fullfile(paradir1,'subj04_06_ICGT.para');
    ...
    EXPT.subject(4).functional(2).para{3} = fullfile(paradir1,'subj04_08_ICGT.para');
    ...
    EXPT.subject(4).functional(3).para{3} = fullfile(paradir1,'subj04_10_ICGT.para');
    ...
    EXPT.subject(4).functional(6).para{3} = fullfile(paradir1,'subj04_16_ICGT.para');
    ...
    EXPT.subject(4).functional(7).para{3} = fullfile(paradir1,'subj04_18_ICGT.para');
    ...
    EXPT.subject(4).functional(8).para{3} = fullfile(paradir1,'subj04_20_ICGT.para');
    ...
    EXPT.subject(4).functional(9).para{3} = fullfile(paradir1,'subj04_22_ICGT.para');
    ...
    EXPT.subject(4).functional(10).para{3} = fullfile(paradir1,'subj04_24_ICGT.para');
    ...
    EXPT.subject(4).functional(11).para{3} = fullfile(paradir1,'subj04_26_ICGT.para');
    ...
    EXPT.subject(4).functional(12).para{3} = fullfile(paradir2,'subj04b_03_ICGT.para');
    ...
    EXPT.subject(4).functional(13).para{3} = fullfile(paradir2,'subj04b_05_ICGT.para');
    ...
    EXPT.subject(4).functional(14).para{3} = fullfile(paradir2,'subj04b_07_ICGT.para');
    ...
    EXPT.subject(4).functional(15).para{3} = fullfile(paradir2,'subj04b_09_ICGT.para');
    ...
    EXPT.subject(4).functional(16).para{3} = fullfile(paradir2,'subj04b_11_ICGT.para');
    ...
    EXPT.subject(4).functional(17).para{3} = fullfile(paradir2,'subj04b_13_ICGT.para');
    ...
    EXPT.subject(4).functional(18).para{3} = fullfile(paradir2,'subj04b_15_ICGT.para');
    ...
    EXPT.subject(4).functional(19).para{3} = fullfile(paradir2,'subj04b_17_ICGT.para');
    ...
    EXPT.subject(4).functional(20).para{3} = fullfile(paradir2,'subj04b_19_ICGT.para');
    ...
    EXPT.subject(4).functional(21).para{3} = fullfile(paradir2,'subj04b_21_ICGT.para');
    ...
    EXPT.subject(4).functional(22).para{3} = fullfile(paradir2,'subj04b_23_ICGT.para');
    ...
    EXPT.subject(4).functional(23).para{3} = fullfile(paradir2,'subj04b_25_ICGT.para');
    ...
    EXPT.subject(4).functional(24).para{3} = fullfile(paradir2,'subj04b_27_ICGT.para');
    ...
    EXPT.subject(4).functional(25).para{3} = fullfile(paradir3,'subj04c_03_ICGT.para');
    ...
    EXPT.subject(4).functional(26).para{3} = fullfile(paradir3,'subj04c_05_ICGT.para');
    ...
    EXPT.subject(4).functional(27).para{3} = fullfile(paradir3,'subj04c_07_ICGT.para');
    ...
    EXPT.subject(4).functional(28).para{3} = fullfile(paradir3,'subj04c_09_ICGT.para');
    ...
    EXPT.subject(4).functional(29).para{3} = fullfile(paradir3,'subj04c_11_ICGT.para');
    ...
    EXPT.subject(4).functional(30).para{3} = fullfile(paradir4,'subj04d_05_ICGT.para');
    ...
    EXPT.subject(4).functional(31).para{3} = fullfile(paradir4,'subj04d_07_ICGT.para');
    ...
    EXPT.subject(4).functional(32).para{3} = fullfile(paradir4,'subj04d_09_ICGT.para');
    ...
    EXPT.subject(4).functional(33).para{3} = fullfile(paradir4,'subj04d_11_ICGT.para');
    ...
    EXPT.subject(4).functional(34).para{3} = fullfile(paradir4,'subj04d_13_ICGT.para');
    ...
    EXPT.subject(4).functional(35).para{3} = fullfile(paradir4,'subj04d_15_ICGT.para');
    ...
    EXPT.subject(4).functional(36).para{3} = fullfile(paradir4,'subj04d_17_ICGT.para');
    ...
    EXPT.subject(4).functional(37).para{3} = fullfile(paradir4,'subj04d_19_ICGT.para');
    ...
    EXPT.subject(4).functional(38).para{3} = fullfile(paradir4,'subj04d_21_ICGT.para');
    ...
    EXPT.subject(4).functional(39).para{3} = fullfile(paradir4,'subj04d_23_ICGT.para');
    ...
    EXPT.subject(4).functional(40).para{3} = fullfile(paradir5,'subj04e_05_ICGT.para');
    ...
    EXPT.subject(4).functional(41).para{3} = fullfile(paradir5,'subj04e_07_ICGT.para');
    ...
    EXPT.subject(4).functional(42).para{3} = fullfile(paradir5,'subj04e_09_ICGT.para');
    ...
    EXPT.subject(4).functional(43).para{3} = fullfile(paradir5,'subj04e_11_ICGT.para');
    ...
    EXPT.subject(4).functional(44).para{3} = fullfile(paradir5,'subj04e_13_ICGT.para');
    ...
    EXPT.subject(4).functional(45).para{3} = fullfile(paradir5,'subj04e_15_ICGT.para');
    ...
    EXPT.subject(4).functional(46).para{3} = fullfile(paradir5,'subj04e_17_ICGT.para');
    ...
    EXPT.subject(4).functional(47).para{3} = fullfile(paradir5,'subj04e_19_ICGT.para');
    ...
    EXPT.subject(4).functional(48).para{3} = fullfile(paradir5,'subj04e_21_ICGT.para');
    ...
    EXPT.subject(4).functional(49).para{3} = fullfile(paradir5,'subj04e_23_ICGT.para');
    ...
    EXPT.subject(4).functional(50).para{3} = fullfile(paradir6,'subj04f_03_ICGT.para');
    ...
    EXPT.subject(4).functional(51).para{3} = fullfile(paradir6,'subj04f_05_ICGT.para');
    ...
    EXPT.subject(4).functional(52).para{3} = fullfile(paradir6,'subj04f_07_ICGT.para');
    ...
    EXPT.subject(4).functional(53).para{3} = fullfile(paradir6,'subj04f_09_ICGT.para');
    ...
    EXPT.subject(4).functional(54).para{3} = fullfile(paradir6,'subj04f_11_ICGT.para');
    ...
    EXPT.subject(4).functional(55).para{3} = fullfile(paradir6,'subj04f_13_ICGT.para');
    ...
    EXPT.subject(4).functional(56).para{3} = fullfile(paradir6,'subj04f_15_ICGT.para');
    ...
    EXPT.subject(4).functional(57).para{3} = fullfile(paradir6,'subj04f_17_ICGT.para');
    ...
    EXPT.subject(4).functional(58).para{3} = fullfile(paradir6,'subj04f_19_ICGT.para');
    ...
    EXPT.subject(4).functional(59).para{3} = fullfile(paradir6,'subj04f_21_ICGT.para');
    ...
    EXPT.subject(4).functional(60).para{3} = fullfile(paradir6,'subj04f_23_ICGT.para');
    ...
    EXPT.subject(4).functional(61).para{3} = fullfile(paradir6,'subj04f_25_ICGT.para');
    ...
    EXPT.subject(5).functional(1).para{3} = fullfile(paradir1,'subj05_05_ICGT.para');
    ...
    EXPT.subject(5).functional(2).para{3} = fullfile(paradir1,'subj05_07_ICGT.para');
    ...
    EXPT.subject(5).functional(3).para{3} = fullfile(paradir1,'subj05_09_ICGT.para');
    ...
    EXPT.subject(5).functional(4).para{3} = fullfile(paradir1,'subj05_11_ICGT.para');
    ...
    EXPT.subject(5).functional(5).para{3} = fullfile(paradir1,'subj05_13_ICGT.para');
    ...
    EXPT.subject(5).functional(8).para{3} = fullfile(paradir1,'subj05_19_ICGT.para');
    ...
    EXPT.subject(5).functional(9).para{3} = fullfile(paradir1,'subj05_21_ICGT.para');
    ...
    EXPT.subject(5).functional(10).para{3} = fullfile(paradir1,'subj05_23_ICGT.para');
    ...
    EXPT.subject(5).functional(11).para{3} = fullfile(paradir1,'subj05_25_ICGT.para');
    ...
    EXPT.subject(5).functional(12).para{3} = fullfile(paradir2,'subj05b_05_ICGT.para');
    ...
    EXPT.subject(5).functional(13).para{3} = fullfile(paradir2,'subj05b_07_ICGT.para');
    ...
    EXPT.subject(5).functional(14).para{3} = fullfile(paradir2,'subj05b_09_ICGT.para');
    ...
    EXPT.subject(5).functional(15).para{3} = fullfile(paradir2,'subj05b_11_ICGT.para');
    ...
    EXPT.subject(5).functional(16).para{3} = fullfile(paradir2,'subj05b_13_ICGT.para');
    ...
    EXPT.subject(5).functional(17).para{3} = fullfile(paradir2,'subj05b_15_ICGT.para');
    ...
    EXPT.subject(5).functional(18).para{3} = fullfile(paradir2,'subj05b_17_ICGT.para');
    ...
    EXPT.subject(5).functional(19).para{3} = fullfile(paradir2,'subj05b_19_ICGT.para');
    ...
    EXPT.subject(5).functional(20).para{3} = fullfile(paradir2,'subj05b_21_ICGT.para');
    ...
    EXPT.subject(5).functional(21).para{3} = fullfile(paradir2,'subj05b_23_ICGT.para');
    ...
    EXPT.subject(5).functional(22).para{3} = fullfile(paradir2,'subj05b_25_ICGT.para');
    ...
    EXPT.subject(5).functional(23).para{3} = fullfile(paradir2,'subj05b_27_ICGT.para');
    ...
    EXPT.subject(5).functional(24).para{3} = fullfile(paradir2,'subj05b_29_ICGT.para');
    ...
    EXPT.subject(5).functional(25).para{3} = fullfile(paradir2,'subj05b_31_ICGT.para');
    ...
    EXPT.subject(5).functional(26).para{3} = fullfile(paradir3,'subj05c_05_ICGT.para');
    ...
    EXPT.subject(5).functional(27).para{3} = fullfile(paradir3,'subj05c_07_ICGT.para');
    ...
    EXPT.subject(5).functional(28).para{3} = fullfile(paradir3,'subj05c_09_ICGT.para');
    ...
    EXPT.subject(5).functional(29).para{3} = fullfile(paradir3,'subj05c_11_ICGT.para');
    ...
    EXPT.subject(5).functional(30).para{3} = fullfile(paradir3,'subj05c_13_ICGT.para');
    ...
    EXPT.subject(5).functional(31).para{3} = fullfile(paradir3,'subj05c_15_ICGT.para');
    ...
    EXPT.subject(5).functional(32).para{3} = fullfile(paradir3,'subj05c_17_ICGT.para');
    ...
    EXPT.subject(5).functional(33).para{3} = fullfile(paradir3,'subj05c_19_ICGT.para');
    ...
    EXPT.subject(5).functional(34).para{3} = fullfile(paradir3,'subj05c_21_ICGT.para');
    ...
    EXPT.subject(5).functional(35).para{3} = fullfile(paradir3,'subj05c_23_ICGT.para');
    ...
    EXPT.subject(5).functional(36).para{3} = fullfile(paradir3,'subj05c_25_ICGT.para');
    ...
    EXPT.subject(5).functional(37).para{3} = fullfile(paradir3,'subj05c_27_ICGT.para');
    ...
    EXPT.subject(5).functional(38).para{3} = fullfile(paradir4,'subj05d_03_ICGT.para');
    ...
    EXPT.subject(5).functional(39).para{3} = fullfile(paradir4,'subj05d_05_ICGT.para');
    ...
    EXPT.subject(5).functional(40).para{3} = fullfile(paradir4,'subj05d_07_ICGT.para');
    ...
    EXPT.subject(5).functional(41).para{3} = fullfile(paradir4,'subj05d_09_ICGT.para');
    ...
    EXPT.subject(5).functional(42).para{3} = fullfile(paradir4,'subj05d_11_ICGT.para');
    ...
    EXPT.subject(5).functional(43).para{3} = fullfile(paradir4,'subj05d_13_ICGT.para');
    ...
    EXPT.subject(5).functional(44).para{3} = fullfile(paradir4,'subj05d_15_ICGT.para');
    ...
    EXPT.subject(5).functional(45).para{3} = fullfile(paradir4,'subj05d_17_ICGT.para');
    ...
    EXPT.subject(5).functional(46).para{3} = fullfile(paradir4,'subj05d_19_ICGT.para');
    ...
    EXPT.subject(5).functional(47).para{3} = fullfile(paradir4,'subj05d_21_ICGT.para');
    ...
    EXPT.subject(5).functional(48).para{3} = fullfile(paradir4,'subj05d_23_ICGT.para');
    ...
    EXPT.subject(5).functional(49).para{3} = fullfile(paradir4,'subj05d_25_ICGT.para');
    ...
    EXPT.subject(6).functional(1).para{3} = fullfile(paradir1,'subj06_03_ICGT.para');
    ...
    EXPT.subject(6).functional(2).para{3} = fullfile(paradir1,'subj06_05_ICGT.para');
    ...
    EXPT.subject(6).functional(5).para{3} = fullfile(paradir1,'subj06_11_ICGT.para');
    ...
    EXPT.subject(6).functional(6).para{3} = fullfile(paradir1,'subj06_13_ICGT.para');
    ...
    EXPT.subject(6).functional(7).para{3} = fullfile(paradir2,'subj06b_03_ICGT.para');
    ...
    EXPT.subject(6).functional(8).para{3} = fullfile(paradir2,'subj06b_05_ICGT.para');
    ...
    EXPT.subject(6).functional(9).para{3} = fullfile(paradir2,'subj06b_07_ICGT.para');
    ...
    EXPT.subject(6).functional(10).para{3} = fullfile(paradir2,'subj06b_09_ICGT.para');
    ...
    EXPT.subject(6).functional(11).para{3} = fullfile(paradir2,'subj06b_11_ICGT.para');
    ...
    EXPT.subject(6).functional(12).para{3} = fullfile(paradir2,'subj06b_13_ICGT.para');
    ...
    EXPT.subject(6).functional(13).para{3} = fullfile(paradir3,'subj06c_03_ICGT.para');
    ...
    EXPT.subject(6).functional(14).para{3} = fullfile(paradir3,'subj06c_05_ICGT.para');
    ...
    EXPT.subject(6).functional(15).para{3} = fullfile(paradir3,'subj06c_07_ICGT.para');
    ...
    EXPT.subject(6).functional(16).para{3} = fullfile(paradir3,'subj06c_09_ICGT.para');
    ...
    EXPT.subject(6).functional(17).para{3} = fullfile(paradir3,'subj06c_11_ICGT.para');
    ...
    EXPT.subject(6).functional(18).para{3} = fullfile(paradir3,'subj06c_13_ICGT.para');
    ...
    EXPT.subject(6).functional(19).para{3} = fullfile(paradir3,'subj06c_15_ICGT.para');
    ...
    EXPT.subject(6).functional(20).para{3} = fullfile(paradir3,'subj06c_17_ICGT.para');
    ...
    EXPT.subject(6).functional(21).para{3} = fullfile(paradir3,'subj06c_19_ICGT.para');
    ...
    EXPT.subject(6).functional(22).para{3} = fullfile(paradir3,'subj06c_21_ICGT.para');
    ...
    EXPT.subject(7).functional(1).para{3} = fullfile(paradir1,'subj07_03_ICGT.para');
    ...
    EXPT.subject(7).functional(2).para{3} = fullfile(paradir1,'subj07_05_ICGT.para');
    ...
    EXPT.subject(7).functional(3).para{3} = fullfile(paradir1,'subj07_07_ICGT.para');
    ...
    EXPT.subject(7).functional(4).para{3} = fullfile(paradir1,'subj07_09_ICGT.para');
    ...
    EXPT.subject(7).functional(5).para{3} = fullfile(paradir1,'subj07_11_ICGT.para');
    ...
    EXPT.subject(7).functional(8).para{3} = fullfile(paradir1,'subj07_17_ICGT.para');
    ...
    EXPT.subject(7).functional(9).para{3} = fullfile(paradir1,'subj07_19_ICGT.para');
    ...
    EXPT.subject(7).functional(10).para{3} = fullfile(paradir1,'subj07_21_ICGT.para');
    ...
    EXPT.subject(7).functional(11).para{3} = fullfile(paradir1,'subj07_23_ICGT.para');
    ...
    EXPT.subject(7).functional(12).para{3} = fullfile(paradir1,'subj07_25_ICGT.para');
    ...
    EXPT.subject(7).functional(13).para{3} = fullfile(paradir2,'subj07b_03_ICGT.para');
    ...
    EXPT.subject(7).functional(14).para{3} = fullfile(paradir2,'subj07b_05_ICGT.para');
    ...
    EXPT.subject(7).functional(15).para{3} = fullfile(paradir2,'subj07b_07_ICGT.para');
    ...
    EXPT.subject(7).functional(16).para{3} = fullfile(paradir2,'subj07b_09_ICGT.para');
    ...
    EXPT.subject(7).functional(17).para{3} = fullfile(paradir2,'subj07b_11_ICGT.para');
    ...
    EXPT.subject(7).functional(18).para{3} = fullfile(paradir2,'subj07b_13_ICGT.para');
    ...
    EXPT.subject(7).functional(19).para{3} = fullfile(paradir2,'subj07b_15_ICGT.para');
    ...
    EXPT.subject(7).functional(20).para{3} = fullfile(paradir2,'subj07b_17_ICGT.para');
    ...
    EXPT.subject(7).functional(21).para{3} = fullfile(paradir2,'subj07b_19_ICGT.para');
    ...
    EXPT.subject(7).functional(22).para{3} = fullfile(paradir2,'subj07b_21_ICGT.para');
    ...
    EXPT.subject(7).functional(23).para{3} = fullfile(paradir2,'subj07b_23_ICGT.para');
    ...
    EXPT.subject(7).functional(24).para{3} = fullfile(paradir2,'subj07b_25_ICGT.para');
    ...
    EXPT.subject(7).functional(25).para{3} = fullfile(paradir3,'subj07c_03_ICGT.para');
    ...
    EXPT.subject(7).functional(26).para{3} = fullfile(paradir3,'subj07c_05_ICGT.para');
    ...
    EXPT.subject(7).functional(27).para{3} = fullfile(paradir3,'subj07c_07_ICGT.para');
    ...
    EXPT.subject(7).functional(28).para{3} = fullfile(paradir3,'subj07c_09_ICGT.para');
    ...
    EXPT.subject(7).functional(29).para{3} = fullfile(paradir3,'subj07c_11_ICGT.para');
    ...
    EXPT.subject(7).functional(30).para{3} = fullfile(paradir3,'subj07c_13_ICGT.para');
    ...
    EXPT.subject(7).functional(31).para{3} = fullfile(paradir3,'subj07c_15_ICGT.para');
    ...
    EXPT.subject(7).functional(32).para{3} = fullfile(paradir3,'subj07c_17_ICGT.para');
    ...
    EXPT.subject(7).functional(33).para{3} = fullfile(paradir3,'subj07c_19_ICGT.para');
    ...
    EXPT.subject(7).functional(34).para{3} = fullfile(paradir3,'subj07c_21_ICGT.para');
    ...
    EXPT.subject(8).functional(1).para{3} = fullfile(paradir1,'subj08_07_ICGT.para');
    ...
    EXPT.subject(8).functional(2).para{3} = fullfile(paradir1,'subj08_09_ICGT.para');
    ...
    EXPT.subject(8).functional(3).para{3} = fullfile(paradir1,'subj08_11_ICGT.para');
    ...
    EXPT.subject(8).functional(4).para{3} = fullfile(paradir1,'subj08_13_ICGT.para');
    ...
    EXPT.subject(8).functional(5).para{3} = fullfile(paradir1,'subj08_15_ICGT.para');
    ...
    EXPT.subject(8).functional(6).para{3} = fullfile(paradir1,'subj08_17_ICGT.para');
    ...
    EXPT.subject(8).functional(9).para{3} = fullfile(paradir1,'subj08_23_ICGT.para');
    ...
    EXPT.subject(8).functional(10).para{3} = fullfile(paradir1,'subj08_25_ICGT.para');
    ...
    EXPT.subject(8).functional(11).para{3} = fullfile(paradir1,'subj08_27_ICGT.para');
    ...
    EXPT.subject(8).functional(12).para{3} = fullfile(paradir2,'subj08b_03_ICGT.para');
    ...
    EXPT.subject(8).functional(13).para{3} = fullfile(paradir2,'subj08b_05_ICGT.para');
    ...
    EXPT.subject(8).functional(14).para{3} = fullfile(paradir2,'subj08b_07_ICGT.para');
    ...
    EXPT.subject(8).functional(15).para{3} = fullfile(paradir2,'subj08b_09_ICGT.para');
    ...
    EXPT.subject(8).functional(16).para{3} = fullfile(paradir2,'subj08b_11_ICGT.para');
    ...
    EXPT.subject(8).functional(17).para{3} = fullfile(paradir2,'subj08b_13_ICGT.para');
    ...
    EXPT.subject(8).functional(18).para{3} = fullfile(paradir2,'subj08b_15_ICGT.para');
    ...
    EXPT.subject(8).functional(19).para{3} = fullfile(paradir2,'subj08b_17_ICGT.para');
    ...
    EXPT.subject(8).functional(20).para{3} = fullfile(paradir2,'subj08b_19_ICGT.para');
    ...
    EXPT.subject(8).functional(21).para{3} = fullfile(paradir3,'subj08c_05_ICGT.para');
    ...
    EXPT.subject(8).functional(22).para{3} = fullfile(paradir3,'subj08c_07_ICGT.para');
    ...
    EXPT.subject(8).functional(23).para{3} = fullfile(paradir3,'subj08c_09_ICGT.para');
    ...
    EXPT.subject(8).functional(24).para{3} = fullfile(paradir3,'subj08c_11_ICGT.para');
    ...
    EXPT.subject(8).functional(25).para{3} = fullfile(paradir3,'subj08c_13_ICGT.para');
    ...
    EXPT.subject(8).functional(26).para{3} = fullfile(paradir3,'subj08c_15_ICGT.para');
    ...
    EXPT.subject(8).functional(27).para{3} = fullfile(paradir3,'subj08c_17_ICGT.para');
    ...
    EXPT.subject(8).functional(28).para{3} = fullfile(paradir3,'subj08c_19_ICGT.para');
    ...
    EXPT.subject(8).functional(29).para{3} = fullfile(paradir3,'subj08c_21_ICGT.para');
    ...
    EXPT.subject(8).functional(30).para{3} = fullfile(paradir3,'subj08c_23_ICGT.para');
    ...
    EXPT.subject(8).functional(31).para{3} = fullfile(paradir3,'subj08c_25_ICGT.para');
