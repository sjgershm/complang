function EXPT = complang01_setup
    ...
    EXPT.analysis_dir = '/mindhive/nklab/projects/MACKEREL/analysis01v2';
    ...
    EXPT.subject(3).functional(1).para{1} = fullfile(paradir1,'subj03_06_ICGT.para');
    ...
    EXPT.subject(3).functional(2).para{1} = fullfile(paradir1,'subj03_08_ICGT.para');
    ...
    EXPT.subject(3).functional(3).para{1} = fullfile(paradir1,'subj03_10_ICGT.para');
    ...
    EXPT.subject(3).functional(6).para{1} = fullfile(paradir1,'subj03_16_ICGT.para');
    ...
    EXPT.subject(3).functional(7).para{1} = fullfile(paradir1,'subj03_18_ICGT.para');
    ...
    EXPT.subject(3).functional(8).para{1} = fullfile(paradir1,'subj03_20_ICGT.para');
    ...
    EXPT.subject(3).functional(11).para{1} = fullfile(paradir2,'subj03b_04_ICGT.para');
    ...
    EXPT.subject(3).functional(12).para{1} = fullfile(paradir2,'subj03b_06_ICGT.para');
    ...
    EXPT.subject(3).functional(13).para{1} = fullfile(paradir2,'subj03b_08_ICGT.para');
    ...
    EXPT.subject(3).functional(14).para{1} = fullfile(paradir2,'subj03b_10_ICGT.para');
    ...
    EXPT.subject(3).functional(17).para{1} = fullfile(paradir2,'subj03b_16_ICGT.para');
    ...
    EXPT.subject(3).functional(18).para{1} = fullfile(paradir2,'subj03b_18_ICGT.para');
    ...
    EXPT.subject(3).functional(19).para{1} = fullfile(paradir2,'subj03b_20_ICGT.para');
    ...
    EXPT.subject(3).functional(20).para{1} = fullfile(paradir2,'subj03b_22_ICGT.para');
    ...
    EXPT.subject(4).functional(1).para{1} = fullfile(paradir1,'subj04_08_ICGT.para');
    ...
    EXPT.subject(4).functional(2).para{1} = fullfile(paradir1,'subj04_10_ICGT.para');
    ...
    EXPT.subject(4).functional(3).para{1} = fullfile(paradir1,'subj04_12_ICGT.para');
    ...
    EXPT.subject(4).functional(5).para{1} = fullfile(paradir1,'subj04_18_ICGT.para');
    ...
    EXPT.subject(4).functional(6).para{1} = fullfile(paradir1,'subj04_20_ICGT.para');
    ...
    EXPT.subject(4).functional(7).para{1} = fullfile(paradir1,'subj04_22_ICGT.para');
    ...
    EXPT.subject(4).functional(8).para{1} = fullfile(paradir2,'subj04b_06_ICGT.para');
    ...
    EXPT.subject(4).functional(9).para{1} = fullfile(paradir2,'subj04b_08_ICGT.para');
    ...
    EXPT.subject(4).functional(10).para{1} = fullfile(paradir2,'subj04b_10_ICGT.para');
    ...
    EXPT.subject(4).functional(11).para{1} = fullfile(paradir2,'subj04b_12_ICGT.para');
    ...
    EXPT.subject(4).functional(14).para{1} = fullfile(paradir2,'subj04b_18_ICGT.para');
    ...
    EXPT.subject(4).functional(15).para{1} = fullfile(paradir2,'subj04b_20_ICGT.para');
    ...
    EXPT.subject(4).functional(16).para{1} = fullfile(paradir2,'subj04b_22_ICGT.para');
    ...
    EXPT.subject(4).functional(17).para{1} = fullfile(paradir2,'subj04b_24_ICGT.para');